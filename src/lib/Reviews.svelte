		...
		{#each reviews as review}
			<a href={review.link} aria-label="See our {review.name} Reviews" class="hover:opacity-75">
				<div class="flex flex-col items-center justify-center space-y-1">
					<div class="w-12 h-12 flex items-center justify-center"> <!-- SVG container with fixed size -->
					...
					<div class="flex items-center space-x-2" aria-hidden="true">
						...
						{#if review.name === 'Hipcamp'}
							...
							<svg class="text-white w-4 h-4" stroke="currentColor" fill="white" stroke-width="0" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
						...
						{:else}
							...
							<svg class="w-4 h-4 text-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor">

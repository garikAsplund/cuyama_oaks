	...
	<div class="grid grid-cols-1 md:grid-cols-2 gap-8 h-full mx-auto md:my-24">
		...
		<div class="flex flex-col justify-center h-full gap-4 order-1 md:order-2">
			<div class="grid grid-cols-2 gap-4">
				<enhanced:img src="/static/camp3.webp" alt="Glamping view 1" class="w-full h-64 object-cover rounded-md" />
				<enhanced:img src="/static/COR-social-card.jpeg" alt="Glamping view 2" class="w-full h-64 object-cover rounded-md" />
			</div>
			<enhanced:img src="/static/camp4.webp" alt="Glamping view 3" class="w-full h-96 object-cover object-top rounded-md" />
		</div>

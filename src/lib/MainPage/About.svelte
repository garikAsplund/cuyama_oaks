...
<section class="scroll-mt-16 z-20 relative bg-white h-auto w-full" id="About">
    <div class="overflow-hidden">
        <section class="relative w-full flex justify-center h-[66vh]">
            <div
                class="md:absolute top-20 right-[5%] w-1/2 h-full z-20 hidden md:block"
            ...
            >
                <h1 class="text-4xl lg:text-7xl font-bold mb-4 w-full">Your hosts</h1>
